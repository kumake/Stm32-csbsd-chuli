...
//与触摸屏芯片连接引脚	   
#define PEN  	PCin(2)  	//PC2 INT
#define DOUT 	PFin(7)   	//PF8  MISO
#define TDIN 	PFout(8)  	//PF9  MOSI
#define TCLK 	PFout(9)  	//PB1  SCLK
#define TCS  	PFout(6)  	//PB2  CS 
...
u8 TP_Init(void);								//初始化
u16 TP_Read_XOY2(u8 cmd_xoy);					//单独获取X或Y的AD值
